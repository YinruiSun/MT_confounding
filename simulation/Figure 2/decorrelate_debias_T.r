...
savefile = paste("decorrelate_debias_T_type_", type, ".RData", sep = "")
save(n, p, s_seq, q, sigma, type, nu, mu, initial, rho, alpha, nrep, results, fdp, power, fdrs, powers, file = savefile)